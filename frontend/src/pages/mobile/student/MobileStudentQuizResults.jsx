...
const MobileStudentQuizResults = () => {
  ...
  if (error || !resultData) {
    return (
      <div className="w-full h-full flex flex-col items-center justify-center font-sans gap-4 p-4 text-center">
  ...
  return (
    <div className="w-full h-full flex flex-col font-sans">
      <div className="mb-6">
        ...
        <div className="flex flex-col gap-1 mt-4 ml-1">
          <h2 className="text-lg font-semibold text-black font-serif">{studentInfo.name}</h2>
          {studentInfo.enrollment && (
            <h2 className="text-sm font-semibold text-black/70 font-serif">{studentInfo.enrollment}</h2>
          )}
        </div>
      </div>
      ...
      <div className="flex flex-col gap-6 flex-1 mb-8">
        ...
        <div className="flex-1">
          {isFormBased ? (
            <div className="flex flex-col gap-6 pr-2 pb-6 overflow-y-auto max-h-[calc(100vh-250px)]">
              <div>
                <h3 className="text-lg font-semibold text-black font-sans mb-3">Form A (Type A Factors)</h3>
                <div className="flex flex-col gap-3">
                  {formA.map((comp, index) => renderCompetencyCard(comp, index))}
                </div>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-black font-sans mb-3">Form B (Type B Factors)</h3>
                <div className="flex flex-col gap-3">
        ...
        <div className="w-full shrink-0 flex flex-col gap-6">
          ...
          <div className="bg-[#3A7654] rounded-2xl p-6 shadow-md flex items-center justify-between">
            <h2 className="text-2xl font-semibold text-[#A7C957] font-sans leading-tight pr-2">
          ...
          <div className="bg-[#CFD8CD] rounded-2xl flex-1 relative overflow-hidden shadow-sm p-6 flex flex-col">
            <div className="relative z-10 flex-1 flex flex-col mb-16">
            ...
            <div className="absolute right-4 bottom-4 w-20 h-20 opacity-80 pointer-events-none">
