...
const AdminProfile = () => {
  const { refreshAdminInfo } = useOutletContext() || {};
    ...
    <div className="w-full h-full flex flex-col font-sans">
      ...
      <div className="bg-[#F3F2F2] rounded-3xl p-8 flex-1 overflow-auto">
        {loading ? (
          ...
          <div className="bg-red-50 text-red-700 p-4 rounded-xl text-sm border border-red-100 font-semibold font-sans">
            {loadError}
          </div>
        ) : (
          <>
            ...
            {saveError && (
              <div className="mb-6 bg-red-50 text-red-700 p-4 rounded-xl text-sm border border-red-100 font-semibold font-sans">
                {saveError}
              </div>
            )}
            ...
            <div className="bg-[#E5E5E5] border border-[#2F3C36] rounded-xl p-8">
              ...
              <form onSubmit={handleProfileUpdate} className="space-y-4 max-w-2xl">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="bg-[#2E7D4F] hover:bg-[#256641] text-white text-sm font-medium px-6 py-2.5 rounded-lg transition-colors mt-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
