...
const ProtectedRoute = ({ children, allowedRole }) => {
  ...
  if (allowedRole && role !== allowedRole) return <Navigate to={loginPath} replace />;
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route
          path="quizzes/:eventId/:quizType/attempt"
          element={isMobile ? <MobileQuizAttempt /> : <QuizAttempt />}
        />

        <Route
          path="quizzes/:attemptId/results"
          element={isMobile ? <MobileStudentQuizResults /> : <StudentQuizResults />}
        />
